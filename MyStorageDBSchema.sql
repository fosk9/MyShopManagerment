use master
GO
IF DB_ID('MyStorage') IS NOT NULL
    BEGIN
        ALTER DATABASE MyStorage SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
        DROP DATABASE MyStorage;
    END
...
USE [master]
GO
ALTER DATABASE [MyStorage] SET  READ_WRITE 
GO
